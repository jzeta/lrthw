...
class Game
  attr_accessor :central_corridor, :laser_weapon_armory, :the_bridge
  attr_accessor :escape_pod, :the_end_winner, :the_end_loser 
  attr_accessor :generic_death, :shoot_death, :dodge_death
  attr_accessor :throw_the_bomb_death, :wrong_code_death, :start
  ...
  def initialize()
    ...
    @throw_the_bomb_death = Room.new("Throw the Bomb Death",
      %q{
